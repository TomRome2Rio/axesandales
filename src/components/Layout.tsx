...
export const Layout: React.FC<LayoutProps> = ({ children, user, onLogin, onLogout, currentPage, onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-neutral-200">
      <nav className="bg-neutral-800/95 backdrop-blur-lg border-b border-neutral-700 sticky top-0 z-50">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="-mr-2 flex md:hidden">
                 <button
                    ...
                    className="bg-neutral-800 border border-neutral-700 inline-flex items-center justify-center p-2 rounded-md text-amber-500 hover:text-white hover:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-neutral-800 focus:ring-amber-500"
                  >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 w-full bg-neutral-800 border-b border-neutral-700 shadow-xl z-50 animate-fade-in">
            ...
            <div className="pt-4 pb-4 border-t border-neutral-700 bg-neutral-900/50">
              {user ? (
                <div className="px-5">
                  <div className="flex items-center">
                    <div className="ml-3">
